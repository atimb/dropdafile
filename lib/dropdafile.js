...
// don't handle attachments, thanks
...
app.configure(function(){
  ...
  // make a custom html template that does nothing
  app.register('.html', {
...
// uploader is uploading (lot of stuff is unneccessary, the code is still in debug mode :)
